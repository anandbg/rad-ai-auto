...
- [ ] **Phase 31: Provider Abstraction Layer** - Environment-driven model config and provider registry with zero behavior change
...
|-------|-----------|----------------|--------|-----------|
| 31. Provider Abstraction Layer | v3.0 | 0/? | Not started | - |
